...
- (void)render: (STMVideoFrame *) frame
{
    ...
    if ([_renderer prepareRender]) {
        ...
        if(frame.cameraF){
            GLKMatrix4 rotateMatrixY = GLKMatrix4MakeRotation(GLKMathDegreesToRadians(180) , 1.0, 0.0, 0.0);
            
            rotateMatrixZ = GLKMatrix4Multiply(rotateMatrixZ, rotateMatrixY);
        }
        
        glUniformMatrix4fv(_uniformMatrix, 1, 0, rotateMatrixZ.m);
